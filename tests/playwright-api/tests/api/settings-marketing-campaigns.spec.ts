...
test.describe('Settings Marketing Campaigns API', () => {
  test('list campaigns without token', async ({ apiClient }) => {
  ...
  test('list campaigns', async ({ marketingCampaignService }) => {
    const response = await marketingCampaignService.list();
    await logResponseOnFailure(response, 'list campaigns');
    expect(response.status()).toBe(200);
  });

  test('create campaign', async ({ marketingCampaignService, emailTemplateService, marketingEventService }) => {
  ...
  test('create campaign with empty payload', async ({ marketingCampaignService }) => {
    const response = await marketingCampaignService.create({});
    await logResponseOnFailure(response, 'create campaign with empty payload');
    expect(response.status()).toBe(422);
  });

  test('show campaign', async ({ marketingCampaignService, emailTemplateService, marketingEventService }) => {
    const templateResponse = await emailTemplateService.create({
      name: unique('Template'),
      subject: 'Hello',
      content: '<p>Hello</p>',
  ...
  test('show campaign not found', async ({ marketingCampaignService }) => {
  ...
  test('update campaign', async ({ marketingCampaignService, emailTemplateService, marketingEventService }) => {
    const templateResponse = await emailTemplateService.create({
      name: unique('Template'),
      subject: 'Hello',
      content: '<p>Hello</p>',
  ...
  test('update campaign with empty payload', async ({ marketingCampaignService, emailTemplateService, marketingEventService }) => {
    const templateResponse = await emailTemplateService.create({
      name: unique('Template'),
      subject: 'Hello',
      content: '<p>Hello</p>',
  ...
  test('delete campaign', async ({ marketingCampaignService, emailTemplateService, marketingEventService }) => {
    const templateResponse = await emailTemplateService.create({
      name: unique('Template'),
      subject: 'Hello',
      content: '<p>Hello</p>',
  ...
  test('delete campaign not found', async ({ marketingCampaignService }) => {
  ...
  test('issue156: show campaign with invalid id', async ({ marketingCampaignService }) => {
    const response = await marketingCampaignService.getById(999999);
    await logResponseOnFailure(response, 'issue156: show campaign with invalid id');
    expect(response.status()).toBe(404);
  });

  test('issue157: update campaign with invalid id', async ({ marketingCampaignService }) => {
  ...
  test('issue158: delete campaign with invalid id', async ({ marketingCampaignService }) => {
    const response = await marketingCampaignService.delete(999999);
    await logResponseOnFailure(response, 'issue158: delete campaign with invalid id');
    expect(response.status()).toBe(404);
  });

  test('issue159: mass destroy campaigns with invalid ids', async ({ marketingCampaignService }) => {
  ...
  test('issue160: import update returns complete response', async ({ marketingCampaignService, authedApi }) => {
    const createResponse = await marketingCampaignService.create({
      name: unique('Campaign'),
      subject: 'Hello',
      status: 0,
  ...
  test('issue161: import create returns complete response', async ({ marketingCampaignService }) => {
    const response = await marketingCampaignService.create({
      name: unique('Campaign'),
      subject: 'Hello',
      status: 0,
